	...
	class Repeater_Control extends \WP_Customize_Control {
		...
		?>
			...
			<div class="cf-cr-repeater cf-cr-droppable">
				...
				?>
							<input type="hidden" id="cf-cr-data" <?php esc_attr( $this->link() ); ?> class="cf-cr-data" value="<?php echo esc_textarea( json_encode( $this_default ) ); ?>">
				<?php
				...
				?>
							<input type="hidden" id="cf-cr-data" <?php esc_attr( $this->link() ); ?> class="cf-cr-data">
				<?php
				...
				?>
						<input type="hidden" id="cf-cr-data" <?php esc_attr( $this->link() ); ?> class="cf-cr-data" value="<?php echo esc_textarea( $this->value() ); ?>">
				...
				?>
					<div class="cf-cr-container cf-cr-draggable">
						...
						<?php
							...
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Title', 'cartfront' ), 'customizer_repeater_title_control' ),
									'class' => 'cf-cr--title',
									'type'  => apply_filters( 'customizer_repeater_input_types_filter', '', 'customizer_repeater_title_control' )
								), $title
							);
							...
							$this->input_control(
								array(
									'label' 			=> apply_filters( 'repeater_input_labels_filter', esc_html__( 'Link', 'cartfront' ), 'customizer_repeater_link_control' ),
									'class' 			=> 'cf-cr-link',
									'sanitize_callback' => 'esc_url_raw',
									'type' 				=> apply_filters( 'customizer_repeater_input_types_filter', '', 'customizer_repeater_link_control' )
								), $link
							);
					...
					<div class="cf-cr-content-hidden">
						<?php
							...
							$this->input_control( array(
								'label' => apply_filters( 'customizer_repeater_input_labels_filter', esc_html__( 'Title', 'cartfront' ), 'customizer_repeater_title_control' ),
								'class' => 'cf-cr--title',
								'type'  => apply_filters( 'customizer_repeater_input_types_filter', '', 'customizer_repeater_title_control' )
							) );
							 ...
							 */
							$this->input_control( array(
								'label' => apply_filters( 'customizer_repeater_input_labels_filter', esc_html__( 'Link','cartfront' ), 'customizer_repeater_link_control' ),
								'class' => 'cf-cr-link',
								'type'  => apply_filters( 'customizer_repeater_input_types_filter', '', 'customizer_repeater_link_control' )
							) );
